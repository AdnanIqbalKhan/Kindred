 ...
 */
public class OrdersPostedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_orders_posted, container, false);


        mOrdersDatabase = FirebaseDatabase.getInstance().getReference().child("posts");
        mOrdersDatabase.keepSynced(true);
        mOrdersListRecyclerView = (RecyclerView) v.findViewById(R.id.posted_orders_recyclerView);
